# Watchtower Pipeline Eval — 2026-07-19T09:10:31Z
...
|-------|------:|
| Items polled (raw) | 36 |
| After dedup + CVE merge | 36 |
| Sent to Groq | 30 |
| Groq findings returned | 3 |
| Passed quality gate | 3 |
| Final cards rendered | 3 |
| **Pipeline yield** | **3/36 (8.3%)** |
...
- **`why_now` avg length**: 56.3 chars (0% ≥ 60 chars, considered substantive)
