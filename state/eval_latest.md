# Watchtower Pipeline Eval — 2026-07-18T23:00:04Z
...
| **Pipeline yield** | **2/63 (3.2%)** |

## Groq
- **Model**: `llama-3.3-70b-versatile`
- **Payload**: 9,589 chars
- **Parse**: ✓  |  **Retries**: 0
- **Rate limit remaining** — requests: 999, tokens: 7647
...
- **`why_now` avg length**: 126 chars (100% ≥ 60 chars, considered substantive)
