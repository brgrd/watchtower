# Watchtower Pipeline Eval — 2026-05-27T23:36:37Z

## Pipeline Yield

| Stage | Count |
|-------|------:|
| Items polled (raw) | 540 |
| After dedup + CVE merge | 537 |
| Sent to Groq | 30 |
| Groq findings returned | 3 |
| Passed quality gate | 3 |
| Final cards rendered | 3 |
| **Pipeline yield** | **3/540 (0.6%)** |

## Groq
- **Model**: `llama-3.3-70b-versatile`
- **Payload**: 11,895 chars
- **Parse**: ✓  |  **Retries**: 0
- **Rate limit remaining** — requests: 999, tokens: 7101
