# Watchtower Pipeline Eval — 2026-09-15T22:06:52Z

## Pipeline Yield

| Stage | Count |
|-------|------:|
| Items polled (raw) | 996 |
| After dedup + CVE merge | 995 |
| Sent to Groq | 4 |
| Groq findings returned | 0 |
| Final cards rendered | 4 |
| **Pipeline yield** | **4/996 (0.4%)** |
