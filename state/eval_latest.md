# Watchtower Pipeline Eval — 2026-07-22T22:12:34Z

## Pipeline Yield

| Stage | Count |
|-------|------:|
| Items polled (raw) | 313 |
| After dedup + CVE merge | 308 |
| Sent to Groq | 25 |
| Groq findings returned | 0 |
| Final cards rendered | 15 |
| **Pipeline yield** | **15/313 (4.8%)** |
...
- New (run=1): **6** | Evolving (2–5): **8** | Persistent (>5): **1** | Resolved: **0**
- Mean run_count: 3.3 | Mean shelf_days: 36.4
