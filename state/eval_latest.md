# Watchtower Pipeline Eval — 2026-06-06T00:16:10Z

## Pipeline Yield

| Stage | Count |
|-------|------:|
| Items polled (raw) | 206 |
| After dedup + CVE merge | 191 |
| Sent to Groq | 30 |
| Groq findings returned | 0 |
| Final cards rendered | 15 |
| **Pipeline yield** | **15/206 (7.3%)** |
...
- New (run=1): **11** | Evolving (2–5): **4** | Persistent (>5): **0** | Resolved: **0**
- Mean run_count: 1.3 | Mean shelf_days: 5.4
