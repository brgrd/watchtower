# Watchtower Pipeline Eval — 2026-06-04T23:18:17Z

## Pipeline Yield

| Stage | Count |
|-------|------:|
| Items polled (raw) | 557 |
| After dedup + CVE merge | 549 |
| Sent to Groq | 24 |
| Groq findings returned | 3 |
| Passed quality gate | 3 |
| Final cards rendered | 3 |
| **Pipeline yield** | **3/557 (0.5%)** |

## Groq
- **Model**: `llama-3.3-70b-versatile`
- **Payload**: 10,646 chars
- **Parse**: ✓  |  **Retries**: 0
- **Rate limit remaining** — requests: 999, tokens: 7470
...
- **`why_now` avg length**: 51.3 chars (0% ≥ 60 chars, considered substantive)
