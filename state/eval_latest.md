# Watchtower Pipeline Eval — 2026-05-08T19:11:02Z

## Pipeline Yield

| Stage | Count |
|-------|------:|
| Items polled (raw) | 472 |
| After dedup + CVE merge | 471 |
| Sent to Groq | 30 |
| Groq findings returned | 3 |
| Passed quality gate | 3 |
| Final cards rendered | 3 |
| **Pipeline yield** | **3/472 (0.6%)** |

## Groq
- **Model**: `llama-3.3-70b-versatile`
- **Payload**: 8,679 chars
- **Parse**: ✓  |  **Retries**: 0
- **Rate limit remaining** — requests: 999, tokens: 7853
